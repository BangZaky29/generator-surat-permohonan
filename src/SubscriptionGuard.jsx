...
const CONFIG = {
    ...
    DEFAULT_FEATURE_SLUG: 'surat-permohonan'
};
...
// =========================================
export const clearSubscriptionSession = (featureSlug = 'surat-permohonan') => {
...
// =========================================
export const hasSubscriptionSession = (featureSlug = 'surat-permohonan') => {
    try {
